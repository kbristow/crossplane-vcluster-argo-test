...
helm install --repo https://argoproj.github.io/argo-helm --create-namespace --namespace argocd argocd argo-cd --version 5.37.1  --set "configs.cm.application\.resourceTrackingMethod=annotation" --wait
